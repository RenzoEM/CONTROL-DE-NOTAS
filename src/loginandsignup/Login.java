...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(44, 111, 179));
        ...
        btnAcceso.setBackground(new java.awt.Color(48, 104, 187));
        ...
        btnInscribirse.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnInscribirse.setForeground(new java.awt.Color(255, 51, 51));
        btnInscribirse.setText("Inscriberse");
                    ...
                    .addGroup(LeftLayout.createSequentialGroup()
                        ...
                        .addGroup(LeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(LeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(btnAcceso, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(LeftLayout.createSequentialGroup()
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/logo-upla-horizontal.jpg"))); // NOI18N
        jPanel1.add(jLabel8);
        jLabel8.setBounds(0, 0, 410, 500);
    ...
    private void btnAccesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccesoActionPerformed
        ...
        if ("".equals(userField.getText())) {
            ...
            JOptionPane.showMessageDialog(new JFrame(), "Password es requerido", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            ...
            if (notFound == 0) {
                ...
                ModuloPrincipal homeFrame = new ModuloPrincipal();

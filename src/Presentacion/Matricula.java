...
public class Matricula extends javax.swing.JInternalFrame {
    ...
    private void jButton1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MousePressed
        ...
        if (validarCamposVacios() && validarNumeros(txtEdad) && validarNumeros(txtCelular) && validarNumeros(txtDni)) {
            ...
            Entidad.Matricula estud = new Entidad.Matricula(txtNombre.getText(), celular, edad, txtDireccion.getText(), dni);
            escribir.registrarEst(estud);
            tabladessing();
        } else {
    ...
    private void txtEdadKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEdadKeyTyped
        ...
        if (txtEdad.getText().trim().length() == 2) {
            Toolkit.getDefaultToolkit().beep();
            JOptionPane.showMessageDialog(null, "Por favor, ingrese un número de rango 2 digitos");
            evt.consume();
        }
    ...
    private void txtCelularKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCelularKeyTyped
        ...
        if (txtCelular.getText().trim().length() == 9) {
            Toolkit.getDefaultToolkit().beep();
            JOptionPane.showMessageDialog(null, "Por favor, ingrese un número de rango 9 digitos");
            evt.consume();
        }
    ...
    private void cargarDatos() {
        ...
        List<Entidad.Matricula> listaEstu = leer.leerEst();

        for (Entidad.Matricula estu : listaEstu) {
            modelMatricula.addRow(new Object[]{estu.getDni(), estu.getNombre(), estu.getCelular(), estu.getEdad(), estu.getDireccion()});
        }
    }
